...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        const binding = require("@rspack/resolver-binding-android-arm64");
        const bindingPackageVersion =
          require("@rspack/resolver-binding-android-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.5.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ) {
          throw new Error(
            `Native binding package version mismatch, expected 0.5.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`
          );
        }
        return binding;
      } catch (e) {
      ...
      try {
        const binding = require("@rspack/resolver-binding-android-arm-eabi");
        const bindingPackageVersion =
    ...
    if (process.arch === "x64") {
      if (
        ...
        try {
          const binding = require("@rspack/resolver-binding-win32-x64-gnu");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-win32-x64-msvc");
          const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-win32-ia32-msvc");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-win32-arm64-msvc");
        const bindingPackageVersion =
    ...
    try {
      const binding = require("@rspack/resolver-binding-darwin-universal");
      const bindingPackageVersion =
    ...
    if (process.arch === "x64") {
      ...
      try {
        const binding = require("@rspack/resolver-binding-darwin-x64");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-darwin-arm64");
        const bindingPackageVersion =
    ...
    if (process.arch === "x64") {
      ...
      try {
        const binding = require("@rspack/resolver-binding-freebsd-x64");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-freebsd-arm64");
        const bindingPackageVersion =
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-x64-musl");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-x64-gnu");
          const bindingPackageVersion =
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-arm64-musl");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-arm64-gnu");
          const bindingPackageVersion =
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-arm-musleabihf");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-arm-gnueabihf");
          const bindingPackageVersion =
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-loong64-musl");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-loong64-gnu");
          const bindingPackageVersion =
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-riscv64-musl");
          const bindingPackageVersion =
        ...
        try {
          const binding = require("@rspack/resolver-binding-linux-riscv64-gnu");
          const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-linux-ppc64-gnu");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-linux-s390x-gnu");
        const bindingPackageVersion =
    ...
    if (process.arch === "arm64") {
      ...
      try {
        const binding = require("@rspack/resolver-binding-openharmony-arm64");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-openharmony-x64");
        const bindingPackageVersion =
      ...
      try {
        const binding = require("@rspack/resolver-binding-openharmony-arm");
        const bindingPackageVersion =
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
    try {
      wasiBinding = require("@rspack/resolver-binding-wasm32-wasi");
      nativeBinding = wasiBinding;
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        if (!wasiBindingError) {
